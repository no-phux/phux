...
| `phux whoami` | who this connection is to the server: principal, auth route, peer uid, serving user and host, server version; read only, `--remote HOST` asks another machine, `--json` for the record |
