...
`HELLO_OK.server_caps.features` contains `TERMINAL_REPLY = 0x40`; an older 0.7
...
no chunk, READY, page, output, or ACK carrying the old BootstrapId is legal.
The client keeps its last published terminal visible until a replacement
reaches READY.
