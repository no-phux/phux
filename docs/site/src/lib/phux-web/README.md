...
`fe1f9563b44f0abf46a75b88d7e4382681f660d4`, based on protocol-0.5 revision
`1f2501f979be972886a1adb805bb598b9189e2f9`. The native image in
`worker/Dockerfile` tracks the workspace phux pin independently. The build
script still rejects any other Phux checkout so this artifact cannot be
