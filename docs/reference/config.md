...
left = [
  { kind = "windows", format = " {index}:{name} ", separator = "", active = { fg = "#1a1b26", bg = "#7aa2f7", bold = true }, inactive = { fg = "#8a93ab", bg = "#1a1b26" } },
]
...
# title           = "#7aa2f7"  # section/window titles (tracks accent)
# chord           = "#9ece6a"  # keybinding chords in help + which-key
# action          = "reset"    # action labels — inherit your terminal fg
# dim             = "#8a93ab"  # the recessive register: hints, sub-lines
# border          = "#7c86a6"  # rules and modal borders
...
# attention       = "#ff9e64"  # "needs you": asked-marker, blocked agents
# sidebar_section = "#8a93ab"  # the sidebar's `spaces` / `agents` headers
# agent_idle      = "#8a93ab"  # agent lifecycle: nothing needs you
...
# divider         = "#7c86a6"  # pane rules off the focused frame
...
# against `surface`, in three ordered rungs: rules 4.7:1, recessive text
# 5.6:1, focus 6.8:1 plus BOLD. Retinting one slot is fine; dropping a
