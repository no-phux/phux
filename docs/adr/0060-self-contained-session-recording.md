...
[`../docs/consumers/tui.md`](../consumers/tui.md) carried a design sketch
...
[`../docs/spec/L1.md`](../spec/L1.md) §5.1 specifies `ATTACH_TERMINAL` as
...
- Timing resolution is the server's output pacing (default 60 Hz,
  [`../docs/spec/proto.md`](../spec/proto.md) §8.1), not per-byte. There
