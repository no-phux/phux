...
//!
//! MODIFIED FROM UPSTREAM (`xai-crash-handler`): report banner text only.
//!
...
pub fn format_report(blob: &CrashBlob, frames: &[ResolvedFrame]) -> String {
    ...
    out.push_str("=== phux Crash Report ===\n\n");
...
mod tests {
    ...
    fn format_report_smoke() {
        ...
        let frames = vec![ResolvedFrame {
            ip: 0xdead_beef,
            symbol_name: Some("phux_client::main".to_string()),
        ...
        assert!(report.contains("phux_client::main"));
