...
pub const ResourceId = support.ResourceId;
...
pub const initialResourceId = local.initialResourceId;
...
pub const pane_card_command_id_base = terminal_painter.pane_card_command_id_base;
pub const pane_focus_command_id_base = terminal_painter.pane_focus_command_id_base;
pub const pane_border_command_id_base = terminal_painter.pane_border_command_id_base;
pub const pane_chrome_inset = projection.pane_chrome_inset;
pub const paneGridRect = projection.paneGridRect;
pub const paneCardRadius = projection.paneCardRadius;
pub const paneFocusRingRect = projection.paneFocusRingRect;
pub const paneFocusRingRadius = projection.paneFocusRingRadius;
