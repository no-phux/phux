...
listing until one of their sessions is picked. Cockpit never pairs a host;
an unregistered one fails with
...
[`phall1/native@2d689c76`](https://github.com/phall1/native/commit/2d689c766df5c919561b366ee2b5a0c7c2e027c1),
...
mirror matching the runtime collector cap, and a `cell_grid`-capable opt-in GPU
composite path with configurable real-frame capture cadence.
...
- At most four Phux coordinators at once. A shown peer's tabs are edited on
  that peer (splits, reorder, close, and New Tab and New Window with its pane
  focused), and its available terminals are placed there. See
